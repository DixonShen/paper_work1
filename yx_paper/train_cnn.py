    ...
    def __init__(self, whether_word2vec, whether_tf, vocab_size, embedding_dim, sequence_length, vocab_processor, num_classes, tf_dict_size,
        ...
        with g.as_default():
            ...
            with self.sess.as_default():
                ...
                # self.grad_summaries_merged = tf.summary.histogram(self.grad_summaries, g)
                ...
                self.loss_summary = tf.summary.histogram("loss", self.cnn.loss)
                self.acc_summary = tf.summary.histogram("accuracy", self.cnn.accuracy)
                ...
                self.fp = open("result_"+str(20170908), "w")
